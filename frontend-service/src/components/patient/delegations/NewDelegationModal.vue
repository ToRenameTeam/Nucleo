...
const handleSearch = async () => {
  ...
  try {
    ...
    searchError.value =
      err instanceof Error ? err.message : t('delegations.newDelegation.searchError');
  } finally {
    ...
    <template #header>
      <div class="custom-header">
        <button
          class="back-button"
          @click="handleBack"
          :aria-label="t('delegations.newDelegation.back')"
        >
    ...
    <div class="new-delegation-content">
      <div class="search-section">
        ...
        <span class="char-counter"
          >{{ remainingChars }} {{ t('delegations.newDelegation.characters') }}</span
        >
