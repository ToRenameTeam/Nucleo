...
/**
 * Reusable factory methods that create fully-constructed domain objects for tests.
 * All IDs are deterministic so assertions are straightforward.
 */
object AppointmentFixtures {
    ...
    val DEFAULT_TIME_SLOT = TimeSlot(
