...
class AppointmentServiceTest : FunSpec({
    ...
    test("createAppointment - should create appointment successfully when availability is available") {
        // Given
    ...
    test("createAppointment - should throw AvailabilityNotFoundException when availability not found") {
        // Given
        val appointmentRepo = FakeAppointmentRepositoryForService()
        ...
        // When & Then
        shouldThrow<AvailabilityNotFoundException> {
            service.createAppointment(command)
        }
    }

    test("createAppointment - should throw AvailabilityNotAvailableException when availability is not available") {
        // Given
        val appointmentRepo = FakeAppointmentRepositoryForService()
        val availabilityRepo = FakeAvailabilityRepositoryForService(
        ...
        // When & Then
        shouldThrow<AvailabilityNotAvailableException> {
            service.createAppointment(command)
        }
    }
    ...
    test("deleteAppointment - should delete appointment successfully") {
        // Given
        val appointmentRepo = FakeAppointmentRepositoryForService()
        val availabilityRepo = FakeAvailabilityRepositoryForService(availabilityStatus = AvailabilityStatus.BOOKED)
        val service = AppointmentService(appointmentRepo, availabilityRepo)
...
class FakeAppointmentRepositoryForService(
