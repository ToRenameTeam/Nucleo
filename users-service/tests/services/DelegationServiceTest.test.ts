...
describe('DelegationService', () => {
  ...
  describe('acceptDelegation', () => {
    ...
    it('should throw error if delegator tries to accept', async () => {
      ...
      await expect(service.acceptDelegation(randomUUID(), delegatorId)).rejects.toThrow(
        'You are not authorized to accept this delegation'
      );
    });
  });
  ...
  describe('deleteDelegation', () => {
    ...
    it('should throw error if random user tries to delete', async () => {
      ...
      await expect(service.deleteDelegation(randomUUID(), randomUUID())).rejects.toThrow(
        'You are not authorized to delete this delegation'
      );
    });
  });
