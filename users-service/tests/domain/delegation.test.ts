import { Delegation } from '../../src/domain/delegation.js';
...
describe('Delegation', () => {
  describe('creation', () => {
    ...
    it('should throw error when delegating to self', () => {
      ...
      expect(() => Delegation.create(id, sameUser, sameUser)).toThrow(
        'cannot delegate to themselves'
      );
    });
  });
  ...
  describe('state transitions', () => {
    ...
    it('should delete active delegation', () => {
      const d = Delegation.reconstitute(
        randomUUID(),
        randomUUID(),
        randomUUID(),
    ...
    it('should throw error on invalid transitions', () => {
      ...
      const active = Delegation.reconstitute(
        randomUUID(),
        randomUUID(),
        randomUUID(),
        DelegationStatus.active()
      );
      const declined = Delegation.reconstitute(
        randomUUID(),
        randomUUID(),
        randomUUID(),
  ...
  describe('permissions', () => {
    ...
    it('should not allow deletion of pending or terminal states', () => {
      ...
      const deleted = Delegation.reconstitute(
        randomUUID(),
        randomUUID(),
        randomUUID(),
